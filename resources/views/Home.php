<?php include "layouts/home.layout.php"; ?>
    ...
    <div class="py-25 bg-linear-to-t from-[#5a1018] via-[#B82132] to-[#B82132] max-w-full pt-10 ">
        <div class="mx-auto flex flex-wrap items-center justify-center md:flex-row container">
            <div class="mb-14 lg:mb-0">
                <div class="max-w-xl text-[2.9rem] text-white font-extrabold font-sans text-center lg-text-5xl lg:text-left lg:leading-tight mb-5">
                ...
                Anda  dapat menemukan panduan praktis, tips, dan best practice dalam membangun antarmuka web yang interaktif dan responsif.
            </div>
...
<!-- Top Tutorial -->
    <div class="container mx-auto my-10">
        <h2 class="max-w-xl text-[2.0rem] text-black font-bold font-sans text-center lg-text-5xl lg:text-left lg:leading-tight mb-5">Top Tutorial</h2>
            ...
            <div class="max-w-sm bg-white rounded-lg shadow-xl dark:border-gray-700 pt-1">
                ...
                <div class="p-3">
                    ...
                    <a href="#">
                        ...
                        <p class="mb-3 font-normal text-sm text-black leading-4">HTML adalah singkatan dari Hypertext Markup Language, HTML merupakan salah satu bahasa pengkodean atau pemograman yang digunakan untuk membuat halaman website ...</p>
                    </a>
                    <a href="#" class="grid grid-cols-2 py-2 text-sm font-medium text-[#B82132]">
                        <p class="">
                            Baca Selengkapnya
                        </p>
                        <svg class="place-self-end w-6 h-6 text-[#B82132]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
...
<!-- Dari FrontendLab -->
    <div class="container mx-auto my-10">
        <div class="bg-white rounded-lg shadow-xl">
            <h2 class="max-w-xl text-[2.0rem] leading-none m-5 text-black font-bold font-sans text-center lg-text-5xl lg:text-left lg:leading-tight mb-5">Dari FrontendLab</h2>
            <div id="gallery" class="relative w-full" data-carousel="slide">
                <!-- Carousel wrapper -->
                <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
                    <?php for($i = 0; $i < 5; $i++) { ?>
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <img src="./img/dari-fl.jpg" class="absolute block max-w-full h-auto -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="">
                    </div>
                    <?php } ?>
                </div>
                <!-- Slider controls -->
        ...
        <!-- Mungkin Anda Sukai -->
            <div class="container">
                ...
                <div class="bg-white rounded-lg shadow-lg mb-5">
                    <div class="flex flex-warp">
                        <a href="#">
                            <img class="w-10 h-10 mb-3 mt-3 ms-5 me-3 rounded-full shadow-lg" src="../img/user.jpg" alt="Bonnie image"/>
                        </a>
                        <ul class="self-center">
                            <a href="#">
                                <li class="font-semibold text-base">Herdy</li>
                    ...
                    <a href="#" class="grid grid-cols-2 py-2 text-sm font-medium text-[#B82132]">
                            ...
                            <svg class=" w-6 h-6 text-[#B82132]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                <path fill-rule="evenodd" d="M10.271 5.575C8.967 4.501 7 5.43 7 7.12v9.762c0 1.69 1.967 2.618 3.271 1.544l5.927-4.881a2 2 0 0 0 0-3.088l-5.927-4.88Z" clip-rule="evenodd"/>
                            </svg>
                        </a>
                </div>
